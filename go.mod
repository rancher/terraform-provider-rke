...
require (
	...
	github.com/rancher/norman v0.0.0-20190227223446-27672c8d7a1f // indirect
	github.com/rancher/rke v0.1.17
	github.com/rancher/types v0.0.0-20190301213616-5b728cea45ab

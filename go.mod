...
require (
	...
	github.com/rancher/norman v0.0.0-20180719172317-c032c4611f2e // indirect
	github.com/rancher/rke v0.1.9
	github.com/rancher/types v0.0.0-20180803173715-42c4836915c2
